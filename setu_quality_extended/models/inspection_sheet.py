    ...
    def create(self, vals_list):
        for vals in vals_list:
            ...
            if vals.get('picking_id'):
                sequence = self.env['stock.picking'].browse(vals['picking_id']).picking_type_id.sequence_for_inspection_sheet
            elif vals.get('production_id'):
                sequence = self.env['mrp.production'].browse(vals['production_id']).picking_type_id.sequence_for_inspection_sheet
            if sequence:
